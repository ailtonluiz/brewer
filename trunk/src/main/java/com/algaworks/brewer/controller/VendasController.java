...
public class VendasController {
	...
	public ModelAndView enviarEmail(Venda venda, BindingResult result, RedirectAttributes attributes,
		...
		attributes.addFlashAttribute("mensagem",
				String.format("Pedido nº %d salvo com sucesso e e-mail enviado", venda.getCodigo()));
		return new ModelAndView("redirect:/vendas/nova");
	}
	...
	@GetMapping
	public ModelAndView pesquisar(VendaFilter vendaFilter, @PageableDefault(size = 8) Pageable pageable,
