...
public class RelatoriosController {
	...
	public ModelAndView relatorioOrcamentoEmitidos() {
		ModelAndView mv = new ModelAndView("relatorio/RelatorioOrcamentosEmitidos");
		mv.addObject(new PeriodoRelatorio());
		return mv;
	}

	@GetMapping("/vendasCanceladas")
	public ModelAndView relatorioVendasCanceladas() {
		ModelAndView mv = new ModelAndView("relatorio/RelatorioVendasCanceladas");
		mv.addObject(new PeriodoRelatorio());
		return mv;
	}
	...
	public ModelAndView gerarRelatorioOrcamentoEmitidos(PeriodoRelatorio periodoRelatorio) {
		Map<String, Object> parametros = new HashMap<>();
		...
		return new ModelAndView("relatorio_orcamentos", parametros);
	}

	@PostMapping("/vendasCanceladas")
	public ModelAndView gerarRelatorioVendasCanceladas(PeriodoRelatorio periodoRelatorio) {
		Map<String, Object> parametros = new HashMap<>();
		...
		return new ModelAndView("relatorio_vendas_canceladas", parametros);
	}
