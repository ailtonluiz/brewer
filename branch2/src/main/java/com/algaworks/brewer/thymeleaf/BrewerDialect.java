...
import com.algaworks.brewer.thymeleaf.processor.ClassForErrorAttibuteTagProcessor;
...
public class BrewerDialect extends AbstractProcessorDialect {
	...
	public Set<IProcessor> getProcessors(String dialectPrefix) {
		...
		processadores.add(new ClassForErrorAttibuteTagProcessor(dialectPrefix));
